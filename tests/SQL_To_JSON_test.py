...
class TestSqlJson(unittest.TestCase):
    ...
    def test_eight(self):
        # res = parse_Sql_To_Json("SELECT Nombre, Ap1, Ap2 FROM Empl, Dedicacion, Persona WHERE Dni=DniEmpl")
    ...
    def test_nine(self):
        # res = parse_Sql_To_Json("SELECT Nombre, Ap1, Ap2 FROM Empl, Dedicacion, Persona, Sector, Jefe WHERE Dni=DniEmpl")
    ...
    def test_ten(self):
        #res = parse_Sql_To_Json("SELECT Nombre, Edad FROM Persona WHERE Pais = \"España\" AND Telefono = 12345")
    ...
    def test_eleven(self):
        #res = parse_Sql_To_Json("SELECT Nombre, Edad FROM Persona WHERE Pais = \"España\" AND Telefono = 12345 AND Id = \"IS1452\"")
